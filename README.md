...
## Description	
This plugin allows you to re-instate the attachments section and to upload attachments without a note.
...
This section will appear below the activities section when viewing the issue.

This version incorporates bug fixes and ensures full compatibility with MantisBT 2.28 and modern 2.X environments.
